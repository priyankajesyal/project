...
<body>
    ...
    <form method="post" action="process/adminsignin1.php">
        <div class="container">
            <div class="box">
              ...
              <div class="center"> <input type="submit" name="submit" value="Sign In" class="btn  btn1 btn-lg"><br><br>
                    <a  class="text-center text-light" href=""> Forget Password</a></span>
              </div>
            </div>
        </div>
