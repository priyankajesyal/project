...
<body>
    ...
    <a href="explore.php"><button class="btn1 btn-lg btn-dark">Explore Us</button></a>
    <h2><span class="heading"> “The beautiful thing about learning is that <br> no one can take it away from you”</span></h2>
</body>
