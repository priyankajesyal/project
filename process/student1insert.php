...
if ($count == 0) {
    ...
    if ($password != $password1) {
        header("location:../student1.php?error1=Passwords Don't Match");
        exit();
    } else {
        ...
        if (mysqli_query($conn, $insert)) {
            header('location:../student1.php?success=Registration successfully');
            exit();
        } else {
    ...
    header('location:../student1.php?error1=Data Already Exists');
    exit();
}
