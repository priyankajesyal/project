...
<body>
	...
	<form name="myform" id="myform" method="post" action="process/student1insert.php" enctype="multipart/form-data">
		<div class="container">
			<div class="box11">
				<center>
				...
				<center> <br><input type="submit" name="submit" class="btn btn-primary"></center>
			</div>
		</div>
	</form>
</body>
